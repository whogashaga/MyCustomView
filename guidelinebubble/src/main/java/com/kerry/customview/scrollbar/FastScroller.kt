...
import com.kerry.customview.scrollbar.extension.compatPaddingStart
import com.kerry.customview.scrollbar.extension.firstVisibleItemPosition
import com.kerry.customview.scrollbar.extension.getCompatDrawable
import com.kerry.customview.scrollbar.extension.isLayoutReversed
import com.kerry.customview.scrollbar.extension.setCompatTint
import com.kerry.customview.scrollbar.extension.wrap
 ...
 *
 * [R.styleable.FastScrollRecyclerView_hideScrollbar]
 * [R.styleable.FastScrollRecyclerView_showBubble]
 * [R.styleable.FastScrollRecyclerView_showBubbleAlways]
 * [R.styleable.FastScrollRecyclerView_showTrack]
 * [R.styleable.FastScrollRecyclerView_handleColor]
 * [R.styleable.FastScrollRecyclerView_trackColor]
 * [R.styleable.FastScrollRecyclerView_bubbleColor]
 * [R.styleable.FastScrollRecyclerView_bubbleSize]
 * [R.styleable.FastScrollRecyclerView_bubbleTextColor]
 * [R.styleable.FastScrollRecyclerView_bubbleTextSize]
 */
@Suppress("MemberVisibilityCanBePrivate", "unused")
class FastScroller : LinearLayout {

    enum class Size(@DrawableRes val drawableId: Int, @DimenRes val textSizeId: Int) {
        BIG(R.drawable.fastscroll_bubble_big, R.dimen.fastscroll_bubble_text_size_big),
    ...
    private fun Context.layout(attrs: AttributeSet? = null, size: Size = Size.NORMAL) {
        ...
        withStyledAttributes(attrs, R.styleable.FastScrollRecyclerView) {
            bubbleColor = getColor(R.styleable.FastScrollRecyclerView_bubbleColor, bubbleColor)
            handleColor = getColor(R.styleable.FastScrollRecyclerView_handleColor, handleColor)
